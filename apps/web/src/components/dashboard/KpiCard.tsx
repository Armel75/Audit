...
export function KpiCard({ label, value, hint, tone, icon: Icon, action }: {
  ...
  return (
    <div className="group rounded-2xl border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600 p-5 shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
