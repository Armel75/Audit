            ...
            <div className="space-y-6">
              <section className="rounded-2xl border border-slate-200 bg-slate-50/60 p-5">
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="recommendation-title" className="mb-1 block text-sm font-medium text-slate-700">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
                    />
                  </div>

                  <div>
                    <label htmlFor="recommendation-action-plan" className="mb-1 block text-sm font-medium text-slate-700">
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    <div>
                      <label htmlFor="recommendation-target-date" className="mb-1 block text-sm font-medium text-slate-700">
                    ...
                    <div>
                      <label htmlFor="recommendation-priority" className="mb-1 block text-sm font-medium text-slate-700">
                        Priorite
                      </label>
                      <select
                    ...
                    <div>
                      <label htmlFor="recommendation-department" className="mb-1 block text-sm font-medium text-slate-700">
                        Departement
                      </label>
                      <select
              ...
              <section className="rounded-2xl border border-slate-200 bg-white p-5">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                  <div>
                    <label htmlFor="recommendation-assignee-user" className="mb-1 block text-sm font-medium text-slate-700">
                      Responsable interne
                    </label>
                    <select
                  ...
                  <div>
                    <label htmlFor="recommendation-assignee-glpi" className="mb-1 block text-sm font-medium text-slate-700">
                  ...
                  <div>
                    <label htmlFor="recommendation-assignee-name" className="mb-1 block text-sm font-medium text-slate-700">
              ...
              <section className="rounded-2xl border border-slate-200 bg-white p-5">
                ...
                >
                  <Paperclip className="mb-3 h-10 w-10 text-slate-300" />
                  <span className="text-sm font-semibold text-indigo-600">Upload a file</span>
                  <span className="mt-1 text-sm text-slate-600">or drag and drop</span>
                  <span className="mt-1 text-xs text-slate-400">PDF, Word, Excel, JPG, PNG, GIF jusqu&apos;a 20MB</span>
                </button>
